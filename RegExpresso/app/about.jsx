    ...
    <SafeAreaView className="bg-background-primary h-full">
      ...
      >
        ...
        <Text className="text-DEFAULT text-2xl font-poppinsMedium text-justify mb-10">
          RegExpresso is a mobile application that converts Regular Expressions to visualize their Finite State Machines.
          TripleThreat created this mobile application for users to visualize their regular expressions in a simple
          and easy to use interface. Have fun using RegExpresso, and start visualizing!
        </Text>
